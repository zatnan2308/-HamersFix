  ...
  $d = [
    ...
    'included' => [
      ...
      'items' => [
        ...
        'Replacement of the flexible vent hose between the dryer and the wall vent connection',
    ...
    'how' => [
      ...
      'steps' => [
        ['num' => '1', 'h3' => 'Book a time',        'p' => "Call or book online. Tell us roughly how many vents and whether it's a home or a business so we come prepared.", 'time' => 'From $179'],
    ...
    'price' => [
      'h3'   => 'Professional air vent cleaning, starting at $179',
      'intro'=> 'The service includes inspection of the dryer vent system and replacement of the flexible vent hose between the dryer and the wall vent connection. Final pricing depends on the number of vents and the size of your property — call us for a quick, clear quote.',
    ...
    'final' => [
      ...
      'signals' => [
        ['title' => 'From $179',         'sub' => 'Clear, upfront pricing'],
