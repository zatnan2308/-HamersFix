...
foreach (['options-global', 'page-home', 'cpt-service', 'page-service-areas', 'page-commercial', 'page-about', 'page-contact', 'page-brands', 'page-services', 'page-reviews'] as $hf_group) {
