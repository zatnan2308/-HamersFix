...
foreach (['options-global', 'page-home', 'cpt-service', 'page-service-areas', 'page-commercial', 'page-about', 'page-contact', 'page-brands', 'page-services', 'page-reviews', 'page-seo'] as $hf_group) {
